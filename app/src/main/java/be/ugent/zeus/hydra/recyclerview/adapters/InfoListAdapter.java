 ...
 */
public class InfoListAdapter extends ItemAdapter<InfoItem, InfoListAdapter.CardViewHolder> {

    @Override
    public CardViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new CardViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.info_card, parent, false));
    }

    protected class CardViewHolder extends RecyclerView.ViewHolder implements DataViewHolder<InfoItem> {
