 ...
 * Show images.
 *
 * Note that this uses, since there still is a framework issue.
 *
...
public class ImageGalleryActivity extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomCaption = findViewById(R.id.caption);
        bottomBehavior = BottomSheetBehavior.from(findViewById(R.id.bottom_sheet));
