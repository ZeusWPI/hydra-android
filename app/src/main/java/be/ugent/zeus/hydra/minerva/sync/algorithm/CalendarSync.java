...
import be.ugent.zeus.hydra.minerva.dto.Agenda;
import be.ugent.zeus.hydra.minerva.dto.AgendaMapper;
import be.ugent.zeus.hydra.minerva.sync.network.AgendaRequest;
...
public class CalendarSync {
    ...
    public boolean synchronise(Account account, boolean isInitialSync) throws RequestException {
        ...
        if (preferences.getBoolean(MinervaFragment.PREF_DETECT_DUPLICATES, false)) {
            agenda = agendaResult.map(new CalendarDuplicateDetector()).getOrThrow();
        } else {
