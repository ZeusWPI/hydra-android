...
import be.ugent.zeus.hydra.account.MinervaAccount;
import be.ugent.zeus.hydra.activities.common.AppCompatAccountAuthenticatorActivity;
...
public class LoginActivity extends AppCompatAccountAuthenticatorActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mAuthTokenType == null)
            mAuthTokenType = MinervaAccount.TOKEN_TYPE;
