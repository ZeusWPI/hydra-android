...
public class UrgentControlFragment extends Fragment {

    private static final String TAG = "UrgentControlFragment";
    ...
    private final MediaControllerCompat.Callback mediaControllerCallback = new MediaControllerCompat.Callback() {
        ...
        public void onPlaybackStateChanged(@NonNull PlaybackStateCompat state) {
            ...
            UrgentControlFragment.this.onPlaybackStateChanged(state);
        }
        ...
        public void onMetadataChanged(MediaMetadataCompat metadata) {
            ...
            UrgentControlFragment.this.onMetadataChanged(metadata);
        }
    };


    public UrgentControlFragment() {
        // Required empty public constructor
    }

    public static UrgentControlFragment newInstance(MediaSessionCompat.Token token) {
        UrgentControlFragment instance = new UrgentControlFragment();
