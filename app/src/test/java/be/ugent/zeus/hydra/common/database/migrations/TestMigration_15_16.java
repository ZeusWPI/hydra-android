...
public class TestMigration_15_16 extends MigrationTest {
    ...
    public void testMigration() throws IOException {
        ...
        SupportSQLiteDatabase version14 = testHelper.createDatabase("test-db", 15);
        version14.close();
        testHelper.runMigrationsAndValidate("test-db", 16, true, new Migration_15_16());
    }
}
