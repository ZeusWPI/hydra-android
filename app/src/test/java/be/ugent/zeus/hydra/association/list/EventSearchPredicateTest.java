...
//
//        List<EventItem> result = data.stream()
//                .filter(e -> searchPredicate.test(e, random.getItem().getAssociation().toLowerCase()))
//                .collect(Collectors.toList());
//
//        assertThat(result, hasItem(random));
//    }
...
//                .filter(d -> d.getItem().getAssociation() != null)
//                .findAny()
...
//
//        List<EventItem> result = data.stream()
//                .filter(e -> searchPredicate.test(e, random.getItem().getAssociation()))
//                .collect(Collectors.toList());
//
//        assertThat(result, hasItem(random));
//    }
